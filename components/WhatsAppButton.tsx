  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Main button */}
        <div className="relative w-14 h-14 sm:w-16 sm:h-16 bg-green-500 hover:bg-green-600 rounded-full shadow-2xl flex items-center justify-center transition-colors">
          {/* WhatsApp Icon */}
          <svg
            viewBox="0 0 24 24"
        ...
        >
          <div className="bg-gray-900 dark:bg-white text-white dark:text-gray-900 px-4 py-2 rounded-lg shadow-lg whitespace-nowrap text-sm">
