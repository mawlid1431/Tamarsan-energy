  ...
  const mainServices = [
    {
      ...
      description:
        "Complete solar photovoltaic system design, installation, and maintenance for residential, commercial, and industrial applications.",
      features: [
      ...
      stats: { number: "500+", label: "kW Installed" },
    },
    {
      icon: Zap,
      title: "Hybrid Energy Systems",
      description:
        "Integrated renewable energy solutions combining solar, diesel, and battery storage for optimal efficiency and reliability.",
      features: [
      ...
      stats: { number: "60%", label: "Fuel Savings" },
    },
    {
      icon: Battery,
      title: "Off-Grid Solutions",
      description:
        "Complete energy independence solutions for remote areas and communities without grid access.",
      features: [
      ...
      stats: { number: "25K+", label: "People Powered" },
    },
    {
      icon: Lightbulb,
      title: "Energy Consultancy",
      description:
        "Expert renewable energy consulting services to help you make informed decisions about your energy future.",
      features: [
      ...
      stats: { number: "100+", label: "Projects Consulted" },
    },
    {
      icon: Settings,
      title: "Engineering & Design",
      description:
        "Professional electrical engineering and design services for power generation, transmission, and distribution systems.",
      features: [
      ...
      stats: { number: "50+", label: "Designs Completed" },
    },
    {
      icon: Wrench,
      title: "Maintenance & Support",
      description:
        "Comprehensive operation and maintenance services to ensure optimal performance and longevity of your energy systems.",
      features: [
      ...
      stats: { number: "99%", label: "Uptime Rate" },
    },
  ];
